    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          collapsed: false,
          items: [
            { type: 'doc', id: 'token/overview', label: 'Overview' },
            { type: 'doc', id: 'token/configuration', label: 'Configuration' },
            { type: 'doc', id: 'token/technical-reference', label: 'Technical Reference' },
          ],
        },
      ],
    },
